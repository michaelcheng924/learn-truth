const BOYS_GIRLS = [
    ...
    },
    {
        ...
        fillQuestion: 'God made the ** of Adam out of the **, and formed ** from the body of Adam',
        fillAnswer: ['body', 'ground', 'eve']
    },
    {
        id: 18,
    ...
    },
    {
        ...
        fillQuestion: 'By ** in the Savior to **',
        fillAnswer: ['believing', 'come']
    },
    {
        id: 55,
    ...
    },
    {
        ...
        fillQuestion: 'The fourth commandment is, Remember the ** day to keep it **. Six days you shall labor and do all your **: but the ** day is the Sabbath of the LORD your God. In it you shall do no work, you nor your son, nor your daughter, nor your manservant, nor your maidservant, nor your cattle, nor your stranger that is within your gates. For in six days the LORD made heaven and earth, the sea, and all that is in them, and rested the seventh day. Therefore the LORD ** the Sabbath day, and hallowed it',
        fillAnswer: ['sabbath', 'holy', 'work', 'seventh', 'blessed']
    },
    {
        id: 79,
    ...
    },
    {
        ...
        fillQuestion: 'The ** day of the week, called the ** Day',
        fillAnswer: ['first', 'lords']
    },
    {
        id: 81,
    ...
    },
    {
        ...
        fillQuestion: 'The tenth commandment is, "You shall not ** your neighbor\'s house, you shall not covet your neighbor\'s wife, nor his manservant, nor his maidservant, nor his ox, nor his donkey, nor any thing that is your neighbor\'s',
        fillAnswer: ['covet']
    },
    {
        id: 94,
    ...
    },
    {
        ...
        fillQuestion: 'To show that His ** belong to Him, and to ** them of what He has ** for them.',
        fillAnswer: ['disciples', 'remind', 'done']
    },
    {
        id: 119,
        question: 'What is baptism?',
        answer: 'The dipping of believers into water, as a sign of their union with Christ in His death, burial and resurrection',
        fillQuestion: 'The ** of believers into **, as a sign of their ** with Christ in His **, burial and **',
        fillAnswer: ['dipping', 'water', 'union', 'death', 'resurrection']
    },
    {
        id: 120,
        ...
        fillQuestion: 'To show believers that God has ** them from their ** through Jesus Christ',
        fillAnswer: ['cleansed', 'sins']
    },
    {
        id: 121,
        question: 'Who are to be baptized?',
        answer: 'Only those who repent of their sins and believe in Christ for salvation',
        fillQuestion: 'Only those who ** of their sins and ** in Christ for salvation',
        fillAnswer: ['repent', 'believe']
    },
    {
        id: 122,
        ...
        fillQuestion: 'No, because the Bible neither ** it, nor gives any ** of it',
        fillAnswer: ['commands', 'example']
    },
    {
        id: 123,
        ...
        fillQuestion: 'The ** of bread and the ** of wine to ** the sufferings and death of Christ',
        fillAnswer: ['eating', 'drinking', 'remember']
    },
    {
        id: 124,
        question: 'What does the bread represent?',
        answer: 'The body of Christ, broken for our sins',
        fillQuestion: 'The ** of Christ, ** for our **',
        fillAnswer: ['body', 'broken', 'sins']
    },
    {
        id: 125,
        question: 'What does the wine represent?',
        answer: 'The blood of Christ, shed for our salvation',
        fillQuestion: 'The ** of Christ, shed for our **',
        fillAnswer: ['blood', 'salvation']
    },
    {
        id: 126,
        ...
        fillQuestion: 'Only those who ** of their sins, ** in Christ for salvation and ** their fellow men',
        fillAnswer: ['repent', 'believe', 'love']
    },
    {
        id: 127,
        ...
        fillQuestion: 'No. He ** from the tomb on the ** day after His death',
        fillAnswer: ['rose', 'third']
    },
    {
        id: 128,
        question: 'Where is Christ now?',
        answer: 'In heaven, seated at the right hand of God the Father',
        fillQuestion: 'In **, seated at the ** hand of God the Father',
        fillAnswer: ['heaven', 'right']
    },
    {
        id: 129,
        question: 'Will Christ come again?',
        answer: 'Yes. At the last day He will come again to judge the world.',
        fillQuestion: 'Yes. At the ** day He will come again to ** the world.',
        fillAnswer: ['last', 'judge']
    },
    {
        id: 130,
        question: 'What happens to men when they die?',
        answer: 'The body returns to dust and the soul goes into the world of spirits',
        fillQuestion: 'The ** returns to ** and the ** goes into the world of **',
        fillAnswer: ['body', 'dust', 'soul', 'spirits']
    },
    {
        id: 131,
        ...
        fillQuestion: 'Yes. "There will be a ** of the dead, both of the ** and **"',
        fillAnswer: ['resurrection', 'just', 'unjust']
    },
    {
        id: 132,
        question: 'What will happen to the wicked in the day of judgment?',
        answer: 'They shall be cast into hell',
        fillQuestion: 'They shall be cast into **',
        fillAnswer: ['hell']
    },
    {
        id: 133,
        ...
        fillQuestion: 'A place of ** and endless **',
        fillAnswer: ['dreadful', 'punishment']
    },
    {
        id: 134,
        ...
        fillQuestion: 'They shall live with Christ **, in a new ** and new **',
        fillAnswer: ['forever', 'heaven', 'earth']
    },
    {
        id: 135,
        question: 'What is heaven?',
        answer: 'A glorious and happy place, where the righteous shall be forever with the Lord',
        fillQuestion: 'A ** and ** place, where the ** shall be ** with the Lord',
        fillAnswer: ['glorious', 'happy', 'righteous', 'forever']
    }
];
